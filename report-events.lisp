...
(defun create-report-events (clog-obj &key (hidden nil) (class nil) (html-id nil) (auto-place t))
  (let ((panel (change-class (clog:create-div clog-obj :content "<div style=\"box-sizing: content-box; position: static; left: 140px; top: 158px;\" id=\"CLOGB3866134998\" data-clog-name=\"cc-db\"></div><select style=\"box-sizing: content-box; position: static; left: 0px; top: 0px; height: 20px; right: 0px; display: inline-block; width: 100%;\" id=\"CLOGB3866134999\" data-clog-name=\"contact-list\"></select><table style=\"box-sizing: content-box; position: static; left: 145px; top: 93px; height: 0px;\" class=\"w3-table-all\" id=\"CLOGB3866135000\" data-clog-name=\"event-table\"></table>"
         :hidden hidden :class class :html-id html-id :auto-place auto-place) 'report-events)))
    (setf (slot-value panel 'event-table) (attach-as-child clog-obj "CLOGB3866135000" :clog-type 'CLOG:CLOG-DB-TABLE :new-id t))
    (setf (slot-value panel 'contact-list) (attach-as-child clog-obj "CLOGB3866134999" :clog-type 'CLOG:CLOG-LOOKUP :new-id t))
    (setf (slot-value panel 'cc-db) (attach-as-child clog-obj "CLOGB3866134998" :clog-type 'CLOG:CLOG-DATABASE :new-id t))
